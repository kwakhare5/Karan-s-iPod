...
export type MenuIDs = (typeof MenuIDs)[keyof typeof MenuIDs];
...
export type BacklightTimeout = 0 | 2 | 5 | 10 | 30 | -1; // -1 = always on, 0 = off, others in seconds
...
export interface MusicPlayer {
  ...
  seekTo: (timeOrFraction: number) => void;
